...
const ModalRemoveAccount = ({ isOpen, onClose }) => {
    ...
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full flex items-center justify-center">
      <div className="relative bg-white rounded-lg shadow-lg" style={{ width: '721', height: '448' }}>
        ...
        <div className="p-6 flex flex-col items-center justify-center">
          ...
          <h2 className="text-2xl font-bold mb-4">Remove This Account?</h2>
          <p className="text-center text-gray-600 mb-8">If you remove this Account, you can add it back later.</p>
      ...
      <ConfirmationModal isOpen={isRemoveModalOpen} onClose={closeModals} />
