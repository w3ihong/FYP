...
interface SuccessSub {
  isOpen: boolean;
  onRequestClose: () => void;
}

const SuccessSubscription: React.FC<SuccessSub> = ({ isOpen, onRequestClose }) => {
  if (!isOpen) {
    return null;
  }
    ...
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-white p-4 rounded-lg shadow-lg max-w-md mx-auto relative w-96 h-60 flex flex-col items-center">
        ...
        <div className="flex flex-col items-center">
          <svg className="h-24 w-24 text-green-500"  width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">  <path stroke="none" d="M0 0h24v24H0z"/>  <rect x="4" y="4" width="16" height="16" rx="2" />  <path d="M9 12l2 2l4 -4" /></svg>
