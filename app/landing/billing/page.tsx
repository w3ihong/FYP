            ...
            {!isChangingPayment && !isChangingAddress ? (
              <>
                ...
                <div className="bg-white p-8 rounded-lg shadow-lg mb-6 w-full lg:w-4/5">
                  <h2 className="bg-gray-100 rounded p-2 text-2xl font-semibold mb-4 text-accent text-base">Current Plan Summary</h2>
                ...
                {/* Payment Method */}
                <div className="bg-white p-8 rounded-lg shadow-lg mb-6 w-full lg:w-4/5">
                  <h2 className="bg-gray-100 rounded p-2 text-2xl font-semibold mb-4 text-accent text-base">Payment Method</h2>
                ...
                <div className="bg-white p-8 rounded-lg shadow-lg w-full lg:w-4/5">
                  <div className='border px-3 py-3'>
                    {/* outer border */}
                    <h2 className="text-2xl font-semibold mb-4 text-accent text-base">Upgrade Your Plan</h2>
                    <div className="flex items-center justify-between ">
                      ...
                      <div className="text-right">
                        ...
                        <Link href="/landing/billing/upgrade" passHref>
