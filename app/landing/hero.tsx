        ...
        <div className="lg:w-1/2 lg:pr-16 md:pr-8 flex flex-col md:items-start md:text-left mb-12 md:mb-0 items-center text-center lg:order-last">
          ...
          <div className="flex justify-center">
            ...
            <Link href='/landing/register'>
              <button className="inline-flex font-raleway text-white bg-accent border-2 border-gray-700 py-1 px-6 hover:bg-SBaccent rounded text-lg">Get Started</button>
            </Link>

            {/* Log in Button */}
            <Link href='/landing/login'>
            <button className="ml-4 inline-flex font-raleway text-gray-700 bg-gray-100 border-2 border-gray-700 py-1 px-12 hover:bg-gray-200 rounded text-lg">Log in</button>
            </Link>
